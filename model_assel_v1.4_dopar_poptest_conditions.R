...
## Start Population
# size class 1
l.start_1 <- 0.34    # physical size in cm
no.start_1 <- 10     # quantity            
sd.start_1 <- 0.04   # standard deviation
# size class 2
l.start_2 <- 0.7     # physical size in cm 
no.start_2 <- 5      # quantity       
sd.start_2 <- 0.05   # standard deviation
# size class 3
l.start_3 <-  0.5    # physical size in cm
no.start_3 <- 5      # quantity      
...
plot(c(0:days), mc.pop.quant[5, ], type = "l", lty = 2, xlab = "time (d)", ylab = "population size (#)", ylim = c(0,max(mc.pop.quant[5, ])), cex.axis = 1.2, cex.lab = 1.2) # max 100% quantil
lines(c(0:days), mc.pop.quant[1, ], type = "l", lty = 2) # min 0% quantil
lines(c(0:days), mc.pop.mean, type = "l", lty = 1) # median
